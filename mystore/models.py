...
class StoreTiming(models.Model):
    store = models.ForeignKey(StoreTimezone, on_delete=models.CASCADE, related_name="timings", )
...
class StoreStatusLog(models.Model):
    store = models.ForeignKey(StoreTimezone, on_delete=models.CASCADE, related_name="status_logs")
...
class StoreReport(models.Model):
    store = models.ForeignKey(StoreTimezone, on_delete=models.CASCADE, related_name="reports",null=True,blank=True)
